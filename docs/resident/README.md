...
try {
    ...
    $request->notificationSettings->timezone = TimezoneEnum::PACIFIC_GAMBIER;
    $request->units = [
        8511,
        279068,
        968865,
...
try {
    ...
    $request->notificationSettings->smsNotifications = false;
    $request->notificationSettings->successfulMeldFrequency = SuccessfulMeldFrequencyEnum::DAILY;
    $request->notificationSettings->timezone = TimezoneEnum::ASIA_THIMPHU;
    $request->units = [
        887265,
        886961,
        880107,
...
try {
    ...
    $request->notificationSettings->smsNotifications = false;
    $request->notificationSettings->successfulMeldFrequency = SuccessfulMeldFrequencyEnum::DAILY;
    $request->notificationSettings->timezone = TimezoneEnum::AMERICA_PANAMA;
    $request->units = [
        160467,
        580107,
        886305,
...
try {
    ...
    $request->patchedResidentInput1->notificationSettings->timezone = TimezoneEnum::PACIFIC_NIUE;
...
try {
    ...
    $request->patchedResidentInput->notificationSettings->timezone = TimezoneEnum::AMERICA_ANTIGUA;
...
try {
    ...
    $request->patchedResidentInput1->notificationSettings->timezone = TimezoneEnum::AMERICA_REGINA;
    $request->patchedResidentInput1->units = [
        29950,
        561577,
        737254,
...
try {
    ...
    $request->residentInput1->notificationSettings->timezone = TimezoneEnum::CANADA_SASKATCHEWAN;
...
try {
    ...
    $request->residentInput->notificationSettings->timezone = TimezoneEnum::EUROPE_SARATOV;
...
try {
    ...
    $request->residentInput1->notificationSettings->timezone = TimezoneEnum::ASIA_ASHKHABAD;
    $request->residentInput1->units = [
        377406,
        705148,
        809365,
